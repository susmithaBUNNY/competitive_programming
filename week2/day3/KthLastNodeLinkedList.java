...
public class Solution {
    ...
    public static LinkedListNode kthToLastNode(int i, LinkedListNode head) {
        ...
        if(i == 0 || lengthOfLinkedList < i)
        {
            throw new IllegalArgumentException("We Cannot perform these type of operations");
        }
        
        LinkedListNode tempnode1 = head;
        
        if (lengthOfLinkedList == i){
            return tempnode1;
        }
        for(int j = 0; j < lengthOfLinkedList-i; j++)
        {
